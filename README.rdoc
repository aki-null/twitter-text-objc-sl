...
Unlike the original library, this library supports OS X 10.6+, but does not work in ARC environment. You will need to add `-licucore` in the `Other Linker Flags` build setting to link the ICU library.
...
RegexKitLite, Copyright © 2008-2010, John Engelhart: http://regexkit.sourceforge.net/RegexKitLite/